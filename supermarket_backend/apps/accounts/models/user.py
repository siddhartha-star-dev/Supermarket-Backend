...
class User(AbstractUser):
    ...
    # Social link
    profile_pic_social = models.URLField(
        blank=True, null=True, verbose_name="Profile Pic Social URL"
    )
    account_type = models.CharField(
        choices=AccountType.choices, default=AccountType.GENERAL, max_length=9
    )
